...
> This retrieves the auth token for emanuel

curl -X POST -F 'username=emanuel' -F 'password=Tameklo31$' http://api:8000/api-token-auth/

http post http://api:8000/api-token-auth/ username=emanuel password=Tameklo31$


> This will retrieve all items

curl -X GET -H 'Authorization: Token de5b8b14ee75ce886db200d3ccfe217db7ea997d' http://api:8000/item/

http http://api:8000/item/ 'Authorization: Token de5b8b14ee75ce886db200d3ccfe217db7ea997d'


> This will retreive a single item

curl -X GET -H 'Authorization: Token de5b8b14ee75ce886db200d3ccfe217db7ea997d' http://api:8000/item/57ce37da-5a93-4ac9-b681-38496d9e92c2/

http http://api:8000/item/57ce37da-5a93-4ac9-b681-38496d9e92c2/ 'Authorization: Token de5b8b14ee75ce886db200d3ccfe217db7ea997d' 

> This retrieve all orders

curl -X GET -H 'Authorization: Token de5b8b14ee75ce886db200d3ccfe217db7ea997d' http://api:8000/order/

http http://api:8000/order/ 'Authorization: Token de5b8b14ee75ce886db200d3ccfe217db7ea997d'

> This will place an order for item id =57ce37da-5a93-4ac9-b681-38496d9e92c2 quantity = 1

curl -X POST -H 'Content-Type: application/json' -H 'Authorization: Token de5b8b14ee75ce886db200d3ccfe217db7ea997d' -d '{"item": "	57ce37da-5a93-4ac9-b681-38496d9e92c2", "quantity": "1"}' http://api:8000/order/

http http://api:8000/order/ 'Authorization: Token de5b8b14ee75ce886db200d3ccfe217db7ea997d' item="57ce37da-5a93-4ac9-b681-38496d9e92c2" quantity="1"


> This get order id = **your_order_uuid**

curl -X GET -H 'Authorization: Token de5b8b14ee75ce886db200d3ccfe217db7ea997d' http://api:8000/order/**your_order_uuid**/

http http://api:8000/order/57ce37da-5a93-4ac9-b681-38496d9e92c2/ 'Authorization: Token de5b8b14ee75ce886db200d3ccfe217db7ea997d'
